        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-foreground hover:text-gray-200 transition-colors"
                    >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-foreground text-background font-heading font-bold py-4 px-8 rounded-lg transition-all duration-300 hover:bg-gray-100"
            >
