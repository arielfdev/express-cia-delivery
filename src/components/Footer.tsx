      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <img src={logo} alt="CIA das Entregas" className="h-16 w-auto mb-6" />
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  ...
                  <span>Rua 24 de Agosto, 2249<br />Esteio/RS</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span>ciadasentregas@yahoo.com.br</span>
                </a>
              </li>
              <li>
                <a
