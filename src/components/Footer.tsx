      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <img src={logo} alt="CIA das Entregas" className="h-10 w-auto mb-6" />
            ...
            <div className="flex gap-4">
              <a
                href="https://wa.me/5551984471357"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-secondary border border-border flex items-center justify-center hover:bg-accent transition-colors duration-200"
              >
